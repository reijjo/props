...
import { escape_html } from "./context-CzXb0Svd.js";
import { attr, head } from "./chunks-C0nfyluv.js";
...
function Navbar($$renderer) {
	$$renderer.push(`<nav class="svelte-1n8e4t1"><div class="wrapper nav-content svelte-1n8e4t1">Hi im a navbar</div></nav>`);
}
function Footer($$renderer, $$props) {
	$$renderer.component(($$renderer2) => {
		$$renderer2.push(`<footer class="svelte-7lfk2o"><div class="wrapper footer-content svelte-7lfk2o">${escape_html((/* @__PURE__ */ new Date()).getFullYear())} © Reijjo - All rights reserved.</div></footer>`);
	});
}
function _layout($$renderer, $$props) {
	...
	Navbar($$renderer);
	$$renderer.push(`<!----> <div class="content svelte-12qhfyh">`);
	children($$renderer);
	$$renderer.push(`<!----></div> `);
	Footer($$renderer);
	$$renderer.push(`<!----></div>`);
...
//# sourceMappingURL=_layout.svelte-Cr7jchVw.js.map
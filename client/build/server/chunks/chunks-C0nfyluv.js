import { clsx } from "./clsx-BHMtmmTK.js";
import { escape_html, pop, push, set_ssr_context, ssr_context } from "./context-CzXb0Svd.js";

//#region .svelte-kit/adapter-bun/chunks/index.js
const DERIVED = 2;
const EFFECT = 4;
...
var Renderer = class Renderer {
	...
	*/
	static #open_render(mode, component, options) {
		const renderer = new Renderer(new SSRState(mode, options.idPrefix ? options.idPrefix + "-" : ""));
...
//#endregion
export { ASYNC, BLOCK_EFFECT, BOUNDARY_EFFECT, BRANCH_EFFECT, CLEAN, COMMENT_NODE, CONNECTED, DERIVED, DESTROYED, DIRTY, EAGER_EFFECT, EFFECT, EFFECT_PRESERVED, EFFECT_RAN, EFFECT_TRANSPARENT, ERROR_VALUE, HEAD_EFFECT, HYDRATION_END, HYDRATION_ERROR, HYDRATION_START, HYDRATION_START_ELSE, INERT, LEGACY_PROPS, MAYBE_DIRTY, REACTION_IS_UPDATING, RENDER_EFFECT, ROOT_EFFECT, STALE_REACTION, STATE_SYMBOL, UNINITIALIZED, USER_EFFECT, WAS_MARKED, attr, head, is_passive_event, render };
//# sourceMappingURL=chunks-C0nfyluv.js.map